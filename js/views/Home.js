    ...
    async render() {
        ...
        let html = personnages.map(perso =>
            ...
            <div class="card shadow-sm">
                <img src="${perso.image}" class="bd-placeholder-img card-img-top" max-width="4vw" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                <div class="card-body">
